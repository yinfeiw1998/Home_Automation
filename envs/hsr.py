...
@env.Action
def MoveArm(arm_lift, arm_flex, arm_roll, wrist_flex, wrist_roll):
    print("MoveArm")
...
@env.Action
def MoveBaseAbs(x, y, theta, v, omega):
    print("MoveBaseAbs")
...
@env.Action
def MoveBaseRel(x, y, theta, v, omega):
    print("MoveBaseRel")
    # x0, y0, theta0 = hsr.subscribers['base_pose'].callback.data['actual']
    # x, y, theta = (
...
@env.Action
def LocateObject(motion_cnt, obj_class, obj_color):
    print('LocateObject')
